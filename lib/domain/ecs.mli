...
module ArchetypeStorage         : ComponentStorage with type component = Components.ArchetypeComponent.t
module PhysicalityStorage       : ComponentStorage with type component = Components.PhysicalityComponent.t
module BehaviorStorage          : ComponentStorage with type component = Components.BehaviorComponent.t
module GoalStorage              : ComponentStorage with type component = Components.GoalComponent.t
...
module ProgressionStorage       : ComponentStorage with type component = Components.ProgressionComponent.t
